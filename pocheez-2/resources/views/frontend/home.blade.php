                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <p>
                                    ...
                                    Enak banget pokoknya, apalagi dalemnya ada keju plus atasnya pake toping kejuu🤩 auto
                                    beli lagi ini mahh😁
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                    Enakkk bgtt😭🫶🏻 mana keju nya luar dalem😭 cocok bgt lah buat yg suka keju kyka akuu🤩
                                    trs tambah enak nya tuh makan nya pas masih anget lumer gmn gituu kejunya😋😋
                                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                </p>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                    Enak kejunya berasa, apalgi kalau dimakan pas masih anget. Open PO lagi dong.
                                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                </p>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                    Keju bangett deh pokoknyaaa. Worth it to buy! 10k dapet banyak isinya padet full keju,
                                    renyh diluar.
                                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                </p>
